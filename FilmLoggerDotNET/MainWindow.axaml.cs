...
namespace FilmLoggerDotNET
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            PosterImage.Loader = new DiskCachedWebImageLoader(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData, Environment.SpecialFolderOption.DoNotVerify), "FilmLoggerDotNET", "Cache"));
        }
